  ...
  return (
    <div className="admin-container">
      ...
      <div className="admin-content">
        <AdminTopbar title="Rider Profile" iconClass="fas fa-user-circle" />
          ...
          <div className="profile-card">
            <div className="profile-header">
              <div className="profile-avatar-container-admin">
                ...
                <label htmlFor="riderAvatarUpload" className="avatar-upload-btn-admin" title="Click to change profile picture">
                  <i className="fas fa-camera"></i>
                </label>
                <input
                  type="file"
                  id="riderAvatarUpload"
                  accept="image/*"
